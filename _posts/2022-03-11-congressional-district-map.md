...
{% picture mini /blog/cjatx-map/overview.png --alt Flowchart of data from senate files through Mapbox tooling to create the static images and interactive map --img class="noshadow" %}
