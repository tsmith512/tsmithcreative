...
{% picture /blog/script-gmail/gscript-new.png --alt Google Apps Script: New Project %}
...
{% picture /blog/script-gmail/regex-whereabouts.png --alt Whereabouts Regular Expressions %}
...
{% picture /blog/script-gmail/regex-gcal.png --alt Google Calendar Regular Expressions %}
...
{% picture /blog/script-gmail/regex-fpl.png --alt FPL Regular Expressions %}
...
{% picture /blog/script-gmail/gmail-all-filter.png --alt Prefilter %}
...
{% picture /blog/script-gmail/gscript-triggers.png --alt Triggers %}
